...
(async () => {
  ...
  // Close search overlay by clicking X
  ...
  // Update selector to strictly match the bottom nav element
  await page.click('div.md\\:hidden a[href="/home-workouts"]', { force: true });
