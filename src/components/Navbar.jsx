...
const Navbar = () => {
  return (
    <nav className="hidden md:flex fixed top-0 z-50 w-full bg-white/90 backdrop-blur-md px-4 sm:px-8 md:px-12 py-3 sm:py-4 shadow-lg border-b border-gray-100">
