...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-md px-4 sm:px-8 md:px-12 py-3 sm:py-4 shadow-sm border-b border-gray-800 pt-safe-top transition-all duration-300">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        {/* Mobile Search Shortcut (Visible on small screens) */}
