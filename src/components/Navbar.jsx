      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <NavLink to="/" className="flex items-center">
          <img
            src={Logo}
            alt="GymX Logo"
            className="w-10 h-10 sm:w-12 sm:h-12 invert" // Invert logo for dark theme
          />
          <span className="ml-3 text-xl font-bold tracking-tight text-white hidden sm:block">GymX</span>
        </NavLink>
