...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-background/80 backdrop-blur-md px-4 sm:px-8 md:px-12 py-3 sm:py-4 shadow-md border-b border-gray-800 pt-safe-top">
