...
const Navbar = () => {
  return (
    <nav className="hidden md:block fixed top-0 z-50 w-full bg-black/70 backdrop-blur-lg px-4 sm:px-8 md:px-12 py-3 sm:py-4 border-b border-gray-800">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <NavLink to="/" className="flex items-center gap-3">
          ...
          />
          <span className="text-white font-bold text-xl tracking-tight">GymX</span>
        </NavLink>
