...
const SearchExercises = ({ onSearch, bodyPart, setBodyPart }) => {
  ...
  return (
    <>
      ...
      {/* Mobile Horizontal Scrollbar - Always visible on Home */}
      <div className="md:hidden mt-8 mb-4 px-4 w-full overflow-hidden">
      ...
      <AnimatePresence>
        {isMobileSearchOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl p-6 pt-safe-top flex flex-col md:hidden"
          >
