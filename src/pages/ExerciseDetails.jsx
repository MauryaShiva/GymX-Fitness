...
const ExerciseDetails = () => {
  ...
  return (
    <motion.main
      className="bg-background text-text-primary min-h-screen pt-4"
      initial="initial"
      animate="in"
      exit="out"
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-full flex justify-center my-12 opacity-30">
          <div className="w-1/3 h-px bg-gradient-to-r from-transparent via-gray-500 to-transparent"></div>
        </div>
