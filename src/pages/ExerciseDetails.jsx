...
const ExerciseDetails = () => {
  ...
  return (
    // ✅ Reverted to dark theme to match new design system
    <motion.main
      className="bg-black text-white min-h-screen px-0 md:px-6 lg:px-8"
    ...
    >
      <div className="max-w-7xl mx-auto md:py-20">
        ...
        <section className="px-4 md:px-0 mb-24 md:mb-0">
          <SimilarExercises
