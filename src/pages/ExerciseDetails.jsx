...
const ExerciseDetails = () => {
  ...
  return (
    <motion.main
      className="bg-background text-text-primary min-h-screen px-0 md:px-6 lg:px-8 pt-safe-top pb-24 md:pb-8"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      exit={{ opacity: 0, y: -20 }}
      transition={{ duration: 0.4, ease: "easeOut" }}
    >
      <div className="max-w-7xl mx-auto py-0 md:py-12">
        <section className="mb-16 md:mb-20">
          <Detail exerciseDetail={exerciseDetail} />
        </section>

        {/* Stylized Divider */}
        <div className="w-full flex justify-center my-12 md:my-20 px-4">
          <div className="w-1/2 md:w-1/3 h-px bg-gradient-to-r from-transparent via-gray-700 to-transparent"></div>
        </div>
        ...
        <section className="px-4 md:px-0 mb-8 md:mb-0">
          <SimilarExercises
