...
const ExerciseDetails = () => {
  ...
  return (
    // ✅ New UI: Dark theme background to match the rest of the application
    <motion.main
      className="bg-background text-text-primary min-h-screen w-full"
    ...
    >
      <div className="max-w-7xl mx-auto py-6 md:py-12">
        ...
        <section id="exercise-videos" className="mb-16 md:mb-24 scroll-mt-24">
          <ExerciseVideos
