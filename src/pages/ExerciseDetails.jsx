...
const ExerciseDetails = () => {
  ...
  return (
    // ✅ Main Page transition container matching dark theme
    <motion.main
      className="bg-black text-white min-h-screen px-4 sm:px-6 lg:px-8"
    ...
    >
      <div className="max-w-7xl mx-auto py-8 md:py-12">
        ...
        {/* ✅ Stylized Divider: Adjusted for dark theme */}
