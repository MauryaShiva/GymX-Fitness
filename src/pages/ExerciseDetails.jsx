...
const ExerciseDetails = () => {
  ...
  return (
    <motion.main
      className="bg-background text-text-primary min-h-safe pt-safe-top"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5, ease: "easeInOut" }}
    >
      <div className="max-w-7xl mx-auto w-full md:py-8 lg:px-8">
        ...
        <section className="mb-12 md:mb-20 px-4 sm:px-6 lg:px-0">
          <ExerciseVideos
        ...
        <section className="px-4 sm:px-6 lg:px-0 pb-24 md:pb-8">
          <SimilarExercises
