...
const ExerciseDetails = () => {
  ...
  return (
    <motion.main
      className="bg-black text-white min-h-screen px-4 sm:px-6 lg:px-8 pb-24 md:pb-8"
    ...
    >
      <div className="max-w-7xl mx-auto py-6 md:py-12">
        ...
        <div className="w-full flex justify-center my-16">
          <div className="w-1/3 h-px bg-gray-800/50"></div>
        </div>

        <section id="exercise-videos" className="mb-16">
          <ExerciseVideos
