...
const ExerciseDetails = () => {
  ...
  return (
    // ✅ Reverted back to the default dark theme app shell style for consistency with the rest of the application
    <motion.main
      className="min-h-screen pt-4 pb-20 px-0 sm:px-6 lg:px-8"
