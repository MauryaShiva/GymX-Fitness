...
const ExerciseDetails = () => {
  ...
  return (
    <motion.main
      className="bg-background text-text-primary min-h-screen px-0 sm:px-6 lg:px-8 pb-24 md:pb-0" // Removed x padding on mobile for full-bleed hero, added pb for BottomNav
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
      exit={{ opacity: 0, x: -20 }}
      transition={{ duration: 0.3 }}
    >
      <div className="w-full max-w-7xl mx-auto py-0 md:py-12">
        <section className="mb-12 md:mb-20">
          <Detail exerciseDetail={exerciseDetail} />
        </section>

        {/* Stylized Divider */}
        <div className="w-full flex justify-center my-10 md:my-16 px-4">
          <div className="w-1/2 md:w-1/3 h-px bg-border"></div>
        </div>

        <section className="mb-12 md:mb-20 px-4 sm:px-0">
          <ExerciseVideos
